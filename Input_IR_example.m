...
rcnt=0;
rcnt=rcnt+1; R(rcnt).Pth='Recordings/aug24/'; R(rcnt).Gpth='Recordings/my_golay_44kHz_N19_0min_24bits'; 
%rcnt=rcnt+1; R(rcnt).Pth='Recordings/sync_recordings/left_position_max-4volume'; R(rcnt).Gpth='RawGolay/my_golay_192kHz_N18_0min_24bits'; 
